...
/* data "oci_core_app_catalog_listing" "test_CloudDevImg_catalog_listing" {
    #Required
    listing_id = "${data.oci_core_app_catalog_listings.CloudDevImg_catalog_listings.id}" //The OCID of the listing.
} */
